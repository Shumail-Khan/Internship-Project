...
const Header = () => {
  return (
    <div className='bg-blue-600 h-full w-full '>
        <div className='flex flex-col md:flex-row flex-wrap px-6 rounded-lg  md:px-10 lg:px-20'>
          {/* left side */}
            <div className='md:w-1/2 flex flex-col items-start justify-center gap-4 py-10 m-auto md:py-[10vw] md:mb-[-30px]'>
               ...
               <di className='flex flex-col md:flex-row items-center gap-3 text-white text-sm font-light'>
                <img className='w-28' src="/Images/group_profiles.png" alt="" />
               ...
               <a className='flex items-center gap-2  bg-white px-8 py-3 rounded-full text-gray-600 text-sm m-auto md:m-0 hover:scale-105 transition-all duration-300' href="#speciality">
                Book appointment <img className='w-3' src="/Images/arrow_icon.svg" alt="" />
               </a>
            </div>
            <div className='md:w-1/2  relative'>
                <img className='w-full md:absolute bottom-0 h-auto rounded-lg ' src="/Images/header_img.png" alt="" />
