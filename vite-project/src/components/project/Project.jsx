...
const Project = () => {
  return (
    ...
    <div className='h-full w-full flex flex-col  bg-gray-900 '>
        <h3 className='text-red-600 text-center mt-20 text-3xl'>Check out my portfolio and share your feedback!</h3>
        <h1 className='text-7xl text-white text-center py-4 font-bold'>My Projects</h1>
